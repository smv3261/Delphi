...
begin
 ...
 //полный путь к КАТОЛОГУ  LOG
 fPathLog  := IncludeTrailingPathDelimiter(PathProg + DirLog);//полный путь КАТОЛОГА  LOG
 //полный путь к КАТОЛОГУ SETTING
 fPathSett := IncludeTrailingPathDelimiter(PathProg + DirSett);//полный путь КАТОЛОГА SETTING
 //полный путь к КАТОЛОГУ REPORT
 fPathRprt := IncludeTrailingPathDelimiter(PathProg + DirReport);//полный путь КАТОЛОГА REPORT
 //полный путь к КАТОЛОГУ HELP
 fPathHelp := IncludeTrailingPathDelimiter(PathProg + DirHlp);//полный путь КАТОЛОГА HELP
 //полный путь к КАТОЛОГУ TEMP
 fPathTemp := IncludeTrailingPathDelimiter(PathProg + DirTmp);//полный путь КАТОЛОГА TEMP
